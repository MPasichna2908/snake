...
function setScore(x){
  ...
  for(let i=5;i>0;i--){
    ...
    if(promena>x || i==1) { 
      ...
      if(i==1 && (promena=='notCompleted' || promena==null)){ console.log("first"); localStorage.setItem(i,x); newScore=i;}//very first
...
//drows the table. gets place or '0'
